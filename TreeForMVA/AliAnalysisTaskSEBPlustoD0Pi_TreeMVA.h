#ifndef AliAnalysisTaskSEBPlustoD0Pi_TreeMVA_H
#define AliAnalysisTaskSEBPlustoD0Pi_TreeMVA_H
/**************************************************************************
...
class AliAnalysisTaskSEBPlustoD0Pi_TreeMVA : public AliAnalysisTaskSE 
{
 ...
 public:
  ...
  Int_t    GetWriteVariableTree() const {return fWriteVariableTree;}
 ...
 private:
  ...
  AliAnalysisTaskSEBPlustoD0Pi_TreeMVA& operator=(const AliAnalysisTaskSEBPlustoD0Pi_TreeMVA& source); 
  ...
  /// \cond CLASSIMP
  ClassDef(AliAnalysisTaskSEBPlustoD0Pi_TreeMVA,1); /// class for BPlus Tree
  /// \endcond
};
