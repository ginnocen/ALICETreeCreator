AliAnalysisTaskSED0_TreeMVA *AddTaskD0_TreeMVA(Int_t flag=0/*0 = D0,1 = LS*/,Bool_t readMC=kFALSE,
				       ...
				       Bool_t DrawDetSignal=false, Bool_t PIDCheck=false, Bool_t FillMassY=false, Bool_t FillMCAcc=true,Int_t AODProtection = 1)
{
  ...
  AliAnalysisTaskSED0_TreeMVA *massD0Task = new AliAnalysisTaskSED0_TreeMVA(taskname.Data(),RDHFD0toKpi);
  ...
  massD0Task->SetWriteVariableTree(2);
