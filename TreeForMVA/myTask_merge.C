...
// Analysis source to be compiled at runtime (if any)
   ...
   gROOT->ProcessLine(".L AliHFTreeHandlerD0toKpi.cxx+g");
   gROOT->ProcessLine(".L AliHFTreeHandlerDplustoKpipi.cxx+g");
   gROOT->ProcessLine(".L AliHFTreeHandlerDstoKKpi.cxx+g");
   gROOT->ProcessLine(".L AliHFTreeHandlerBplustoD0pi.cxx+g");
   gROOT->ProcessLine(".L AliAnalysisTaskSEHFTreeCreator_v1.cxx+g");
