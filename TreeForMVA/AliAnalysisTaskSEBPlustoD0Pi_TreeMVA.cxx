...
#include "AliAnalysisTaskSEBPlustoD0Pi_TreeMVA.h"
...
/// \cond CLASSIMP
ClassImp(AliAnalysisTaskSEBPlustoD0Pi_TreeMVA);
/// \endcond

//__________________________________________________________________________
AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::AliAnalysisTaskSEBPlustoD0Pi_TreeMVA():
  AliAnalysisTaskSE(),
  fEvents(0),
  fUseMCInfo(kFALSE),
  fShowMask(0),
  ...
  fSys(0)  
{
  ...
  Info("AliAnalysisTaskSEBPlustoD0Pi_TreeMVA", "Calling Constructor");
  ...
  DefineOutput(10, TTree::Class());  // BPlusMC output
}
...
AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::~AliAnalysisTaskSEBPlustoD0Pi_TreeMVA() {
  ...
  /// destructor
  //
  Info("~AliAnalysisTaskSEBPlustoD0Pi_TreeMVA", "Calling Destructor");
...
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::Init() {
  //
  /// Initialization
  //

  if (fDebug > 1) printf("AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::Init() \n");

  return;
}
//_________________________________________________
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::UserExec(Option_t *) {
  ...
  if (fWriteVariableTree > 0)PostData(10, fVariablesTree);
...
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::Terminate(Option_t*) {
...
//___________________________________________________________________________
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::UserCreateOutputObjects() {
  /// output
  ...
  if (fWriteVariableTree == 1) {
    ...
    fVariablesTree = new TTree("fTreeBPlus", "fTreeBPlus");
    Int_t nVar = 68;
    fCandidateVariables = new Double_t [nVar];
    TString * fCandidateVariableNames = new TString[nVar];
    fCandidateVariableNames[0] = "D0__inv_mass_width";
    fCandidateVariableNames[1] = "D0__delta_mass_width";
    fCandidateVariableNames[2] = "D0__pointing_angle";
    fCandidateVariableNames[3] = "D0__dca";
    fCandidateVariableNames[4] = "D0__Pt_D0";
    fCandidateVariableNames[5] = "D0__Pt_First_daughter";
    fCandidateVariableNames[6] = "D0__Pt_Second_daughter";
    fCandidateVariableNames[7] = "D0__d0_D0";
    fCandidateVariableNames[8] = "D0__d0_First_daughter";
    fCandidateVariableNames[9] = "D0__d0_Second_daughter";
    fCandidateVariableNames[10] = "D0__d0d0";
    fCandidateVariableNames[11] = "D0__d0d0_XY";
    fCandidateVariableNames[12] = "D0__angle_between_both_daughters";
    fCandidateVariableNames[13] = "D0__angle_mother_with_first_daughter";
    fCandidateVariableNames[14] = "D0__angle_mother_with_second_daughter";
    fCandidateVariableNames[15] = "D0__cosThetaStar";
    fCandidateVariableNames[16] = "D0__vertexDistance";
    fCandidateVariableNames[17] = "D0__pseudoProperDecayTime";
    fCandidateVariableNames[18] = "D0__DecayTime";
    fCandidateVariableNames[19] = "D0__normalizedDecayTime";
    fCandidateVariableNames[20] = "D0__normDecayLength";
    fCandidateVariableNames[21] = "D0__topomatic_first_daughter";
    fCandidateVariableNames[22] = "D0__topomatic_second_daughter";
    fCandidateVariableNames[23] = "D0__topomatic_max";
    fCandidateVariableNames[24] = "D0__topomatic_min";
    fCandidateVariableNames[25] = "D0__pointing_angle_XY";
    fCandidateVariableNames[26] = "D0__vertex_distance_XY";
    fCandidateVariableNames[27] = "D0__normalized_decay_length_XY";
    fCandidateVariableNames[28] = "D0__chi_squared_per_NDF";
    fCandidateVariableNames[29] = "D0__pointingAngleToBPlus";
    fCandidateVariableNames[30] = "D0__d0MotherToBPlus";
    fCandidateVariableNames[31] = "D0__d0FirstDaughterToBPlus";
    fCandidateVariableNames[32] = "D0__d0SecondDaughterToBPlus";
    fCandidateVariableNames[33] = "D0__impactProductToBPlus";
    fCandidateVariableNames[34] = "D0__impactProductXYToBPlus";
    fCandidateVariableNames[35] = "D0__normDecayLengthToBPlus";
    fCandidateVariableNames[36] = "D0__pseudoProperDecayTimeToBPlus";
    fCandidateVariableNames[37] = "D0__DecayTimeToBPlus";
    fCandidateVariableNames[38] = "D0__normalizedDecayTimeToBPlus";
    fCandidateVariableNames[39] = "BPlus__inv_mass_width";
    fCandidateVariableNames[40] = "BPlus__delta_mass_width";
    fCandidateVariableNames[41] = "BPlus__pointing_angle";
    fCandidateVariableNames[42] = "BPlus__dca";
    fCandidateVariableNames[43] = "BPlus__Pt_BPlus";
    fCandidateVariableNames[44] = "BPlus__Pt_D0";
    fCandidateVariableNames[45] = "BPlus__Pt_Pion";
    fCandidateVariableNames[46] = "BPlus__d0_BPlus";
    fCandidateVariableNames[47] = "BPlus__d0_D0";
    fCandidateVariableNames[48] = "BPlus__d0_Pion";
    fCandidateVariableNames[49] = "BPlus__d0d0";
    fCandidateVariableNames[50] = "BPlus__d0d0_XY";
    fCandidateVariableNames[51] = "BPlus__angle_between_both_daughters";
    fCandidateVariableNames[52] = "BPlus__angle_mother_with_first_daughter";
    fCandidateVariableNames[53] = "BPlus__angle_mother_with_second_daughter";
    fCandidateVariableNames[54] = "BPlus__cosThetaStar";
    fCandidateVariableNames[55] = "BPlus__vertexDistance";
    fCandidateVariableNames[56] = "BPlus__pseudoProperDecayTime";
    fCandidateVariableNames[57] = "BPlus__DecayTime";
    fCandidateVariableNames[58] = "BPlus__normalizedDecayTime";
    fCandidateVariableNames[59] = "BPlus__normDecayLength";
    fCandidateVariableNames[60] = "BPlus__topomatic_first_daughter";
    fCandidateVariableNames[61] = "BPlus__topomatic_second_daughter";
    fCandidateVariableNames[62] = "BPlus__topomatic_max";
    fCandidateVariableNames[63] = "BPlus__topomatic_min";
    fCandidateVariableNames[64] = "BPlus__pointing_angle_XY";
    fCandidateVariableNames[65] = "BPlus__vertex_distance_XY";
    fCandidateVariableNames[66] = "BPlus__normalized_decay_length_XY";
    fCandidateVariableNames[67] = "BPlus__chi_squared_per_NDF";
  ...
  else if (fWriteVariableTree == 2) {
    fTreeHandler = new AliHFCutOptTreeHandler(AliHFCutOptTreeHandler::kBplustoD0pi, AliHFCutOptTreeHandler::kNsigmaPID, fUseMCInfo);
    if (fSys > 0) fTreeHandler->SetUseCentrality();
    if (fUseMCInfo && fWriteOnlySignal) fTreeHandler->SetFillOnlySignal();
    fTreeHandler->SetIsMC(fUseMCInfo);
    fVariablesTree = (TTree*)fTreeHandler->BuildTree("fTreeBPlus", "fTreeBPlus");
  }
...
void  AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::DefineHistograms() {
  /// Create histograms
...
//-------------------------------------------------------------------------------------
AliAODVertex* AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::RecalculateVertex(const AliVVertex *primary, TObjArray *tracks, Double_t bField, Double_t dispersion) {
  //
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::BPlustoD0PiSignalTracksInMC(TClonesArray * mcTrackArray, AliAODEvent*  aodevent, TMatrix * BPlustoD0PiLabelMatrix, TList *listout) {
...
//-------------------------------------------------------------------------------------
Bool_t AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::D0FirstDaughterSelection(AliAODTrack* aodTrack, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
Bool_t AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::D0SecondDaughterSelection(AliAODTrack* aodTrack, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::BPlusPionSelection(AliAODEvent* aodEvent, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::D0Selection(AliAODEvent* aodEvent, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, TClonesArray * D0TracksFromFriendFile, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::BPlusSelection(AliAODEvent* aodEvent, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, TClonesArray * D0TracksFromFriendFile, AliAODMCHeader * header) {
      ...
      for (Int_t iRot = 0; iRot < 1; ++iRot)
      {
        ...
        if (TMath::Abs(invariantMassMother - pdgMassMother) < massWindow)
        {
          ...
          if (fWriteVariableTree == 2) {
            ...
            if (fUseMCInfo) {
              fTreeHandler->SetCandidateType(isDesiredCandidate, 1, 0);
              fTreeHandler->SetVariables(&trackBPlus, 0, pidHF, 0x0);
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::FillFinalTrackHistograms(AliAODRecoDecayHF2Prong * selectedBPlus, AliAODVertex *primaryVertex, Double_t bz, Bool_t isDesiredCandidate, TClonesArray * mcTrackArray) {
...
//-------------------------------------------------------------------------------------
Double_t AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::DeltaInvMassBPlusKpipi(AliAODRecoDecayHF2Prong * BPlus) const
{
  ///
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::FillD0Histograms(AliAODRecoDecayHF2Prong * selectedMother, AliAODVertex *primaryVertex, Double_t bz, Int_t motherType, Int_t histType, Int_t pdgCodeMother) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::FillBPlusHistograms(AliAODRecoDecayHF2Prong * selectedMother, AliAODVertex *primaryVertex, Double_t bz, Int_t motherType, Int_t histType) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::TwoTrackCombinationInfo(AliExternalTrackParam * firstTrack, AliExternalTrackParam * secondTrack, AliAODVertex * primaryVertex, Double_t bz, Bool_t isDesiredCandidate, TString histogram_name, UInt_t prongs[2]) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::ThreeTrackCombinationInfo(AliExternalTrackParam * firstTrack, AliExternalTrackParam * secondTrack, AliExternalTrackParam * thirdTrack, AliAODVertex * primaryVertex, Double_t bz, Bool_t isDesiredCandidate, TString histogram_name, UInt_t prongs[3]) {
...
//-------------------------------------------------------------------------------------
Int_t AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::MatchCandidateToMonteCarlo(Int_t pdgabs, AliAODRecoDecayHF2Prong * candidate, TClonesArray *mcArray, TMatrix * BPlustoD0PiLabelMatrix) const
{
  //
...
//-------------------------------------------------------------------------------------
Int_t AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::IsTrackInjected(AliAODTrack *part, AliAODMCHeader *header, TClonesArray *arrayMC) {
...
//-------------------------------------------------------------------------------------
Bool_t AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::IsCandidateInjected(AliAODRecoDecayHF2Prong *selectedBPlus, AliAODMCHeader *header, TClonesArray *arrayMC) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::CutOptimizationLoop(Int_t variable, Int_t nVariables, Int_t nCuts, Int_t ptBin, Int_t fillNumber, Bool_t isDesiredCandidate) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::CutOptimizationVariableValues(AliAODRecoDecayHF2Prong * candidateBPlus, AliAODEvent*  aod) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi_TreeMVA::FillTreeVariableValues(AliAODRecoDecayHF2Prong * candidateBPlus, AliAODEvent*  aod) {
  ...
  if(kTRUE) 
  {
    ...
    // "inv. mass width [GeV]" --------------------------------------------
    nCutIndex = 0;
    fCandidateVariables[nCutIndex] = invMassDifference;
    //---------------------------------------------------------------------

    // "delta mass width [GeV]" -------------------------------------------
    nCutIndex = 1; // not used for D0
    fCandidateVariables[nCutIndex] = 0;
    //---------------------------------------------------------------------

    // "pointing angle [Cos(theta)]" --------------------------------------
    nCutIndex = 2;
    fCandidateVariables[nCutIndex] = pointingAngle;
    //---------------------------------------------------------------------

    // "dca [cm]" ---------------------------------------------------------
    nCutIndex = 3;
    fCandidateVariables[nCutIndex] = dcaMother;
    //---------------------------------------------------------------------

    // "Pt D0 [GeV/c]" ----------------------------------------------------
    nCutIndex = 4;
    fCandidateVariables[nCutIndex] = ptMother;
    //---------------------------------------------------------------------

    // "Pt Kaon [GeV/c]" -------------------------------------------------
    nCutIndex = 5;
    fCandidateVariables[nCutIndex] = ptKaon;
    //---------------------------------------------------------------------

    // "Pt Pion [GeV/c]" --------------------------------------------------
    nCutIndex = 6;
    fCandidateVariables[nCutIndex] = ptPion;
    //---------------------------------------------------------------------

    // "d0 D0 [cm]" -------------------------------------------------------
    nCutIndex = 7;
    fCandidateVariables[nCutIndex] = d0Mother;
    //---------------------------------------------------------------------

    // "d0 Kaon [cm]"-----------------------------------------------------
    nCutIndex = 8;
    fCandidateVariables[nCutIndex] = d0firstTrack;
    //---------------------------------------------------------------------

    // "d0 Pion [cm]" -----------------------------------------------------
    nCutIndex = 9;
    fCandidateVariables[nCutIndex] = d0secondTrack;
    //---------------------------------------------------------------------

    // "d0d0 [cm^2]" ------------------------------------------------------
    nCutIndex = 10;
    fCandidateVariables[nCutIndex] = impactProduct;
    //---------------------------------------------------------------------

    // "d0d0 XY [cm^2]" ---------------------------------------------------
    nCutIndex = 11;
    fCandidateVariables[nCutIndex] = impactProductXY;
    //---------------------------------------------------------------------

    // "angle between both daughters" -------------------------------------
    nCutIndex = 12;
    fCandidateVariables[nCutIndex] = angleBetweenBothDaughters;
    //---------------------------------------------------------------------

    // "angle mother with first daughter" ---------------------------------
    nCutIndex = 13;
    fCandidateVariables[nCutIndex] = angleMotherFirstDaughter;
    //---------------------------------------------------------------------

    // "angle mother with second daughter" --------------------------------
    nCutIndex = 14;
    fCandidateVariables[nCutIndex] = angleMotherSecondDaughter;
    //---------------------------------------------------------------------

    // "cosThetaStar" -----------------------------------------------------
    nCutIndex = 15;
    fCandidateVariables[nCutIndex] = cosThetaStar;
    //---------------------------------------------------------------------

    // "vertexDistance" ---------------------------------------------------
    nCutIndex = 16;
    fCandidateVariables[nCutIndex] = vertexDistance;
    //---------------------------------------------------------------------

    // "pseudoProperDecayTime" --------------------------------------------
    nCutIndex = 17;
    fCandidateVariables[nCutIndex] = pseudoProperDecayTime;
    //---------------------------------------------------------------------

    // "DecayTime" --------------------------------------------------------
    nCutIndex = 18;
    fCandidateVariables[nCutIndex] = decayTime;
    //---------------------------------------------------------------------

    // "normalizedDecayTime" ----------------------------------------------------
    nCutIndex = 19;
    fCandidateVariables[nCutIndex] = normalizedDecayTime;
    //---------------------------------------------------------------------

    // "normDecayLength" --------------------------------------------------
    nCutIndex = 20;
    fCandidateVariables[nCutIndex] = normDecayLength;
    //---------------------------------------------------------------------

    // "topomatic first daughter" -----------------------------------------
    nCutIndex = 21;
    fCandidateVariables[nCutIndex] = dd0pr1;
    //---------------------------------------------------------------------

    // "topomatic second daughter" ----------------------------------------
    nCutIndex = 22;
    fCandidateVariables[nCutIndex] = dd0pr2;
    //---------------------------------------------------------------------

    // "topomatic max" ----------------------------------------------------
    nCutIndex = 23;
    fCandidateVariables[nCutIndex] = dd0max;
    //---------------------------------------------------------------------

    // "topomatic min" ----------------------------------------------------
    nCutIndex = 24;
    fCandidateVariables[nCutIndex] = dd0min;
    //---------------------------------------------------------------------

    // "pointing angle XY" ----------------------------------------------------
    nCutIndex = 25;
    fCandidateVariables[nCutIndex] = cosPointingAngleXY;
    //---------------------------------------------------------------------

     // "vertex distance XY" ----------------------------------------------------
    nCutIndex = 26;
    fCandidateVariables[nCutIndex] = distanceXYToVertex;
    //---------------------------------------------------------------------
    
     // "normalized decay length XY" ----------------------------------------------------
    nCutIndex = 27;
    fCandidateVariables[nCutIndex] = normalizedDecayLengthXY;
    //---------------------------------------------------------------------
    
    // "chi squared per NDF" ----------------------------------------------------
    nCutIndex = 28;
    fCandidateVariables[nCutIndex] = chi2Vertex;
    //---------------------------------------------------------------------          
    ...
    // "pointingAngleToBPlus" ---------------------------------------------
    nCutIndex = 29;
    fCandidateVariables[nCutIndex] = pointingAngleToBPlus;
    //---------------------------------------------------------------------

    // "d0MotherToBPlus" --------------------------------------------------
    nCutIndex = 30;
    fCandidateVariables[nCutIndex] = d0D0DSVert;
    //---------------------------------------------------------------------

    // "d0FirstDaughterToBPlus" -------------------------------------------
    nCutIndex = 31;
    fCandidateVariables[nCutIndex] = d0FirstDaughterToBPlus;
    //---------------------------------------------------------------------

    // "d0SecondDaughterToBPlus" ------------------------------------------
    nCutIndex = 32;
    fCandidateVariables[nCutIndex] = d0SecondDaughterToBPlus;
    //---------------------------------------------------------------------

    // "impactProductToBPlus" ---------------------------------------------
    nCutIndex = 33;
    fCandidateVariables[nCutIndex] = impactProductToBPlus;
    //---------------------------------------------------------------------

    // "impactProductXYToBPlus" -------------------------------------------
    nCutIndex = 34;
    fCandidateVariables[nCutIndex] = impactProductXYToBPlus;
    //---------------------------------------------------------------------

    // "normDecayLengthToBPlus" -------------------------------------------
    nCutIndex = 35;
    fCandidateVariables[nCutIndex] = normDecayLengthToBPlus;
    //---------------------------------------------------------------------

    // "pseudoProperDecayTimeToBPlus" -------------------------------------
    nCutIndex = 36;
    fCandidateVariables[nCutIndex] = pseudoProperDecayTimeToBPlus;
    //---------------------------------------------------------------------

    // "DecayTimeToBPlus" -------------------------------------------------
    nCutIndex = 37;
    fCandidateVariables[nCutIndex] = DecayTimeToBPlus;
    //---------------------------------------------------------------------

    // "normalizedDecayTimeToBPlus" ---------------------------------------------
    nCutIndex = 38;
    fCandidateVariables[nCutIndex] = normalizedDecayTimeToBPlus;
    //---------------------------------------------------------------------
  }
 ...
 // save B0 variable information
  ...
  {     
    ...
    // "delta mass width [GeV]" -------------------------------------------
    nCutIndex = 40;
    fCandidateVariables[nCutIndex] = invMassDelta;
    //---------------------------------------------------------------------
    ...
    // "Pt D0 [GeV/c]" -------------------------------------------------
    nCutIndex = 44;
    fCandidateVariables[nCutIndex] = ptD0;
    //---------------------------------------------------------------------
