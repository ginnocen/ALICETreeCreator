...
void makeCutsTreeCreator_PbPb2018_080(Bool_t isMC = kFALSE, Int_t OptPreSelect = 1, Bool_t PIDcorrection = kTRUE, Int_t TPCClsPID = 50, Double_t minptLc = 2, Bool_t spdkAnyLc = kTRUE, Bool_t ispass1 = kFALSE)
{
  ...
  if(ispass1) fname += "_080_pass1.root";
  else        fname += "_080.root";
