...
void makeCutsTreeCreator_PbPb2018_080(Bool_t isMC = kFALSE, Bool_t PreSelectpK0s = kTRUE, Bool_t doBin24pK0s = kFALSE)
{
  ...
  AliRDHFCutsLctoV0  *looseCutsLctoV0bachelor    = makeInputCutsLctoV0(0,"Lc2V0bachelorFilteringCuts",minCent,maxCent,isMC,PreSelectpK0s,doBin24pK0s);
  Printf("\n\n");
  Printf("LctoV0bachelor analysis cuts");
  AliRDHFCutsLctoV0  *analysisCutsLctoV0bachelor = makeInputCutsLctoV0(1,"Lc2V0bachelorAnalysisCuts",minCent,maxCent,isMC,PreSelectpK0s,doBin24pK0s);
  Printf("\n\n");
  Printf("*************************************************************");
  ...
  if(!isMC){
    if(PreSelectpK0s){
      if(doBin24pK0s) fout=new TFile("LcpK0sCuts_PreSelect_PbPb2018_080_noPIDCalib_pT2to4.root","recreate");
      else fout=new TFile("LcpK0sCuts_PreSelect_PbPb2018_080_noPIDCalib.root","recreate");
    } else {
      if(doBin24pK0s) fout=new TFile("LcpK0sCuts_NoPreSelect_PbPb2018_080_noPIDCalib_pT2to4.root","recreate");
      else fout=new TFile("LcpK0sCuts_NoPreSelect_PbPb2018_080_noPIDCalib.root","recreate");
    }
  } else{
    if(PreSelectpK0s){
      fout=new TFile("LcpK0sCuts_PreSelect_PbPb2018_MC_080_noPIDCalib_pTge2.root","recreate");
    } else {
      fout=new TFile("LcpK0sCuts_NoPreSelect_PbPb2018_MC_080_noPIDCalib_pTge2.root","recreate");
    }
  }
  fout->cd();
