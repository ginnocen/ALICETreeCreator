...
AliRDHFCutsDstoKKpi *makeInputCutsDstoKKpi(Int_t whichCuts=0, TString nameCuts="DstoKKpiFilteringCuts", Float_t minc=30.,Float_t maxc=50.)
{
...
//        Float_t cutsArrayDstoKKpi[20]={0.3,0.3,0.3,0.,0.,0.,0.06,0.02,0.,0.9,0.,100000.,0.03,0.0001,-1.,1.,0.,0.,0.,-1.};
        ...
        */
        ...
        Float_t topomCuts[nptbins] = {1.5,1.5,2.5,2.5,2.}; //topomatic
