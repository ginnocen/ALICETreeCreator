...
AliRDHFCutsD0toKpi *makeInputCutsD0toKpi(Int_t whichCuts=0, TString nameCuts="D0toKpiFilteringCuts", Float_t minc=30.,Float_t maxc=50.)
{
    ...
    //    //5-inf
        ...
        cutsD0toKpi->SetMinPtCandidate(4.);
    ...
    cutsD0toKpi->SetTriggerMask(AliVEvent::kSemiCentral | AliVEvent::kINT7);
