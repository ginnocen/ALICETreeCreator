...
void makeCutsTreeCreator_PbPb2018_SemiCentral(Bool_t isMC = kFALSE)
{
  ...
  TFile* fout;
  if(!isMC) fout=new TFile("D0DsDplusDstarLcBplusBsLbCuts_PbPb2018_SemiCentral.root","recreate");
  else fout=new TFile("D0DsDplusDstarLcBplusBsLbCuts_PbPb2018_MC_SemiCentral.root","recreate");
  fout->cd();
