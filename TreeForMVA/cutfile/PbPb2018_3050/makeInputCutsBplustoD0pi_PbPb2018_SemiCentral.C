...
AliRDHFCutsD0toKpi *makeInputCutsBplustoD0pi(Int_t whichCuts=0, TString nameCuts="BplustoD0piFilteringCuts", Float_t minc=30.,Float_t maxc=50.,Bool_t isMC=kFALSE){
