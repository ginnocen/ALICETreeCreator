...
AliRDHFCutsD0toKpi *makeInputCutsBplustoD0pi(Int_t whichCuts=0, TString nameCuts="BplustoD0piFilteringCuts", Float_t minc=30., Float_t maxc=50., Bool_t isMC=kFALSE, Int_t OptPreSelect = 1, Int_t TPCClsPID = 50, Bool_t PIDcorrection=kTRUE, Bool_t ispass1 = kFALSE){
  ...
  if(whichCuts==0){
    ...
    //    //5-inf
    cutsArrayD0toKpi[0][0]=0.2;  //D0 inv mass window
    cutsArrayD0toKpi[1][0]=999999.;
    cutsArrayD0toKpi[2][0]=1.1;
    cutsArrayD0toKpi[3][0]=0.;
    cutsArrayD0toKpi[4][0]=0.;
