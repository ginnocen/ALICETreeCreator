...
AliRDHFCutsD0toKpi *makeInputCutsD0toKpi(Int_t whichCuts=0, TString nameCuts="D0toKpiFilteringCuts", Float_t minc=30., Float_t maxc=50., Bool_t isMC=kFALSE, Int_t OptPreSelect = 1, Int_t TPCClsPID = 50, Bool_t PIDcorrection=kTRUE, Bool_t ispass1 = kFALSE)
{
  ...
  cutsD0toKpi->SetUseTrackSelectionWithFilterBits(kTRUE);
  //UPDATE 08/06/20, Add cut on TPC clusters for PID (similar to geometrical cut)
  cutsD0toKpi->SetMinNumTPCClsForPID(TPCClsPID);
  ...
  if(whichCuts==0){
    ...
    Float_t varyCosPoint[nptbins][nvary]={{0.75,0.80,0.80},  /* 0<pt<0.5 */
                                          ...
                                          {0.75,0.80,0.80},  /* 1<pt<1.5 */
                                          {0.75,0.80,0.80},  /* 1.5<pt<2 */
                                          {0.92,0.94,0.94},  /* 2<pt<2.5 */
                                          {0.92,0.94,0.94},  /* 2.5<pt<3 */
                                          {0.90,0.92,0.94},  /* 3<pt<3.5 */
                                          {0.90,0.92,0.94},  /* 3.5<pt<4 */
                                          {0.85,0.90,0.94},  /* 4<pt<4.5 */
                                          {0.85,0.90,0.94},  /* 4.5<pt<5 */
    ...
    Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,400.*1E-4,0.8,0.3,0.3,1000.*1E-4,1000.*1E-4,varyd0xd0[0][vcd0xd0],varyCosPoint[0][vccospoint],0.99,6.},/* 0<pt<0.5*/
                                                    ...
                                                    {0.400,300.*1E-4,0.8,0.4,0.4,1000.*1E-4,1000.*1E-4,varyd0xd0[2][vcd0xd0],varyCosPoint[2][vccospoint],0.993,5.},/* 1<pt<1.5 */
                                                    {0.400,300.*1E-4,0.8,0.4,0.4,1000.*1E-4,1000.*1E-4,varyd0xd0[3][vcd0xd0],varyCosPoint[3][vccospoint],0.993,5.},/* 1.5<pt<2 */
                                                    {0.400,250.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,varyd0xd0[4][vcd0xd0],varyCosPoint[4][vccospoint],0.995,6.},/* 2<pt<2.5 */
                                                    {0.400,250.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,varyd0xd0[5][vcd0xd0],varyCosPoint[5][vccospoint],0.995,6.},/* 2.5<pt<3 */
                                                    {0.400,250.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[6][vcd0xd0],varyCosPoint[6][vccospoint],0.995,6.},/* 3<pt<3.5 */
                                                    {0.400,250.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[7][vcd0xd0],varyCosPoint[7][vccospoint],0.995,6.},/* 3.5<pt<4 */
                                                    {0.400,250.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[8][vcd0xd0],varyCosPoint[8][vccospoint],0.995,6.},/* 4<pt<4.5*/
                                                    {0.400,250.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[9][vcd0xd0],varyCosPoint[9][vccospoint],0.995,6.},/* 4.5<pt<5*/
                                                    {0.400,250.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[10][vcd0xd0],varyCosPoint[10][vccospoint],0.995,6.},/* 5.5<pt<6 */
                                                    {0.400,250.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[11][vcd0xd0],varyCosPoint[11][vccospoint],0.995,6.},/* 6<pt<6.5 */
                                                    {0.400,270.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[12][vcd0xd0],varyCosPoint[12][vccospoint],0.995,6.},/* 6.5<pt<7 */
                                                    {0.400,270.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[13][vcd0xd0],varyCosPoint[13][vccospoint],0.995,6.},/* 7<pt<7.5 */
                                                    {0.400,270.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[14][vcd0xd0],varyCosPoint[14][vccospoint],0.995,6.},/* 7.5<pt<8 */
                                                    ...
                                                    {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[19][vcd0xd0],varyCosPoint[19][vccospoint],0.995,5.},/* 10<pt<12 */
                                                    {0.400,350.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[20][vcd0xd0],varyCosPoint[20][vccospoint],0.994,5.},/*12< pt <14*/
                                                    {0.400,350.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[21][vcd0xd0],varyCosPoint[21][vccospoint],0.994,5.},/*14< pt <16*/
                                                    {0.400,350.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[22][vcd0xd0],varyCosPoint[22][vccospoint],0.994,5.},/*16< pt <20*/
                                                    {0.400,400.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[23][vcd0xd0],varyCosPoint[23][vccospoint],0.994,5.},/*20< pt <24*/
                                                    {0.400,400.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[24][vcd0xd0],varyCosPoint[24][vccospoint],0.993,4.},/*24< pt <36*/
                                                    {0.400,400.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[25][vcd0xd0],varyCosPoint[25][vccospoint],0.994,5.},/*36< pt <50*/
                                                    {0.400,400.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[26][vcd0xd0],varyCosPoint[26][vccospoint],0.994,5.},/*50< pt <100*/
                                                    {0.400,400.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[27][vcd0xd0],varyCosPoint[27][vccospoint],0.994,5.}};/* pt > 100*/
  ...
  if(!isMC && PIDcorrection) cutsD0toKpi->EnableNsigmaDataDrivenCorrection(kTRUE, AliAODPidHF::kPbPb5080);

  //event selection
  cutsD0toKpi->SetUsePhysicsSelection(kTRUE);
  cutsD0toKpi->SetTriggerClass("");
  if(!isMC) cutsD0toKpi->SetTriggerMask(AliVEvent::kINT7);
