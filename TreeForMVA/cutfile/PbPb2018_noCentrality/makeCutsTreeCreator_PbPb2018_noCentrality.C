...
void makeCutsTreeCreator_PbPb2018_noCentrality(Bool_t usePID = kTRUE)
{
  ...
  AliRDHFCutsBPlustoD0Pi  *looseCutsBplustoD0pi    = makeInputCutsBplustoD0pi(0,"BplustoD0piFilteringCuts",minCent,maxCent,usePID);
  Printf("\n\n");
  Printf("Bplus analysis cuts");
  AliRDHFCutsBPlustoD0Pi  *analysisCutsBplustoD0pi = makeInputCutsBplustoD0pi(1,"BplustoD0piAnalysisCuts",minCent,maxCent,usePID);
  Printf("*************************************************************");
