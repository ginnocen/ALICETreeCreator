...
AliRDHFCutsDstoKKpi *makeInputCutsBstoDspi_pp(Int_t whichCuts=0, TString nameCuts="BstoDspiFilteringCuts", Float_t minc=0.,Float_t maxc=100.)
{
  ...
  if(whichCuts==0){
    ...
    //Used values for Ds analysis taken at 05/08/19
    Float_t** anacutsval;
