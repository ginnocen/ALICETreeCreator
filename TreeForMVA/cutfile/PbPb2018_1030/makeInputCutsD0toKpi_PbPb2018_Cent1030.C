...
AliRDHFCutsD0toKpi *makeInputCutsD0toKpi(Int_t whichCuts=0, TString nameCuts="D0toKpiFilteringCuts", Float_t minc=0., Float_t maxc=10., Bool_t isMC=kFALSE, Int_t OptPreSelect = 1, Int_t TPCClsPID = 50, Bool_t PIDcorrection=kTRUE, Bool_t ispass1 = kFALSE)
{
  ...
  //NB: Don't put lower than 0.5, otherwise different cuts in 0-20 and 20-80
  ...
  if(whichCuts==0){
    ...
    const Int_t nvary=3;
    Float_t varyd0xd0[nptbins][nvary]={{-35000.*1E-8,-40000.*1E-8,-30000.*1E-8},/* pt<0.5*/
      {-35000.*1E-8,-40000.*1E-8,-30000.*1E-8},/* 0.5<pt<1*/
    ...
    Float_t varyCosPoint[nptbins][nvary]={{0.75,0.80,0.90},  /* 0<pt<0.5 */
      {0.75,0.80,0.90},  /* 0.5<pt<1*/
      {0.75,0.80,0.90},  /* 1<pt<1.5 */
      {0.75,0.80,0.90},  /* 1.5<pt<2 */
    ...
    Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,400.*1E-4,0.8,0.3,0.3,1000.*1E-4,1000.*1E-4,varyd0xd0[0][vcd0xd0],varyCosPoint[0][vccospoint],0.991,5.},/* 0<pt<0.5*/
      {0.400,400.*1E-4,0.8,0.3,0.3,1000.*1E-4,1000.*1E-4,varyd0xd0[1][vcd0xd0],varyCosPoint[1][vccospoint],0.991,5.},/* 0.5<pt<1*/
      ...
      {0.400,400.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[20][vcd0xd0],varyCosPoint[20][vccospoint],0.998,5.},/*12< pt <14*/
      {0.400,400.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,varyd0xd0[21][vcd0xd0],varyCosPoint[21][vccospoint],0.998,5.},/*14< pt <16*/
  ...
  if(!isMC && PIDcorrection) cutsD0toKpi->EnableNsigmaDataDrivenCorrection(kTRUE, AliAODPidHF::kPbPb1030);
