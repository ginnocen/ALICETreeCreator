#ifndef AliAnalysisTaskSED0_TreeMVA_H
#define AliAnalysisTaskSED0_TreeMVA_H
...
///*************************************************************************
/// \class Class AliAnalysisTaskSED0_TreeMVA
...
class AliAnalysisTaskSED0_TreeMVA : public AliAnalysisTaskSE
{
 public:

  AliAnalysisTaskSED0_TreeMVA();
  AliAnalysisTaskSED0_TreeMVA(const char *name,AliRDHFCutsD0toKpi* cuts);
  virtual ~AliAnalysisTaskSED0_TreeMVA();
  ...
  void SetArray(Int_t type=AliAnalysisTaskSED0_TreeMVA::kD0){fArray=type;}
  enum{kD0,kLS};
  ...
  void SetWriteVariableTree(Int_t flag) { fWriteVariableTree=flag; }
  ...
  void SetFillSubSampleHist(Bool_t flag) {fFillSubSampleHist=flag;}
    void SetWriteOnlySignalTree(Bool_t flag){fWriteOnlySignal=flag;}
 ...
 private:
  ...
  AliAnalysisTaskSED0_TreeMVA(const AliAnalysisTaskSED0_TreeMVA &source);
  AliAnalysisTaskSED0_TreeMVA& operator=(const AliAnalysisTaskSED0_TreeMVA& source); 
  ...
  /// \cond CLASSIMP
  ClassDef(AliAnalysisTaskSED0_TreeMVA,24); /// AliAnalysisTaskSE for D0->Kpi
  /// \endcond
};
