...
AliAnalysisGrid* CreateAlienHandler(TString pluginmode, TString testfileslistWithPlugin, Bool_t fIsMC, TString period, TString recopass) {
  ...
  TString friendchainname = "./AliAOD.VertexingHF.root";
   ...
   plugin->SetGridWorkingDir(Form("Dplus_pp_5TeV_%s_%s",period.Data(),recopass.Data()));
   // Name of executable
   plugin->SetExecutable(Form("Dplus_pp_5TeV_%s_%s.sh",period.Data(),recopass.Data()));
   ...
   plugin->SetAnalysisSource("AliHFCutOptTreeHandler.cxx AliAnalysisTaskSEDplus_TreeMVA.cxx");

   // Declare all libraries (other than the default ones for the framework. These will be
   // loaded by the generated analysis macro. Add all extra files (task .cxx/.h) here.
   plugin->SetAdditionalLibs("libPWGflowBase.so libPWGflowTasks.so libPWGHFbase.so libPWGHFvertexingHF.so AliHFCutOptTreeHandler.h AliHFCutOptTreeHandler.cxx AliAnalysisTaskSEDplus_TreeMVA.h AliAnalysisTaskSEDplus_TreeMVA.cxx");
