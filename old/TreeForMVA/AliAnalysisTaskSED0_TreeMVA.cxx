...
/// \cond CLASSIMP
ClassImp(AliAnalysisTaskSED0_TreeMVA);
/// \endcond

//________________________________________________________________________
AliAnalysisTaskSED0_TreeMVA::AliAnalysisTaskSED0_TreeMVA():
  AliAnalysisTaskSE(),
  fOutputMass(0),
  fOutputMassPt(0),
  fOutputMassY(0),
...
//________________________________________________________________________
AliAnalysisTaskSED0_TreeMVA::AliAnalysisTaskSED0_TreeMVA(const char *name,AliRDHFCutsD0toKpi* cuts):
...
//________________________________________________________________________
void AliAnalysisTaskSED0_TreeMVA::Init()
{
  /// Initialization
...
//________________________________________________________________________
void AliAnalysisTaskSED0_TreeMVA::UserCreateOutputObjects()
{
  ...
  //
    if(fWriteVariableTree==1){
        ...
        fTreeHandler = new AliHFCutOptTreeHandler(AliHFCutOptTreeHandler::kD0toKpi,AliHFCutOptTreeHandler::kNsigmaPID,fReadMC);
        if(fSys>0) fTreeHandler->SetUseCentrality();
        if(fReadMC && fWriteOnlySignal) fTreeHandler->SetFillOnlySignal();
        fTreeHandler->SetIsMC(fReadMC);
...
//________________________________________________________________________
void AliAnalysisTaskSED0_TreeMVA::UserExec(Option_t */*option*/)

{
  ...
  if(!inputArray || !aod) {
    printf("AliAnalysisTaskSED0_TreeMVA::UserExec: input branch not found!\n");
    return;
  }
  ...
  if(fReadMC) {
    ...
    if(!mcArray) {
      printf("AliAnalysisTaskSED0_TreeMVA::UserExec: MC particles branch not found!\n");
      return;
    }
    ...
    if(!mcHeader) {
      printf("AliAnalysisTaskSED0_TreeMVA::UserExec: MC header branch not found!\n");
      return;
    }
  }
...
void AliAnalysisTaskSED0_TreeMVA::DrawDetSignal(AliAODRecoDecayHF2Prong *part, TList *ListDetSignal)
{
  //
...
//____________________________________________________________________________
void AliAnalysisTaskSED0_TreeMVA::FillVarHists(AliAODEvent* aod,AliAODRecoDecayHF2Prong *part, TClonesArray *arrMC, AliRDHFCutsD0toKpi *cuts, TList *listout){
  //
...
//____________________________________________________________________________
void AliAnalysisTaskSED0_TreeMVA::FillMassHists(AliAODRecoDecayHF2Prong *part, TClonesArray *arrMC, AliAODMCHeader *mcHeader, AliRDHFCutsD0toKpi* cuts, TList *listout, AliAODEvent* aodev){
    //
    ...
    if ((fIsSelectedCandidate==1 || fIsSelectedCandidate==3) && fFillOnlyD0D0bar<2) { //D0
        ...
        if(fReadMC){
            ...
            if(fWriteVariableTree==2){
                ...
                fTreeHandler->SetVariables(part,masshypo,pidHF,0x0);
...
AliAODVertex* AliAnalysisTaskSED0_TreeMVA::GetPrimaryVtxSkipped(AliAODEvent *aodev){
...
//________________________________________________________________________
void AliAnalysisTaskSED0_TreeMVA::Terminate(Option_t */*option*/)
{
  /// Terminate analysis
  //
...
//________________________________________________________________________
void AliAnalysisTaskSED0_TreeMVA::CreateImpactParameterHistos(){
...
Float_t AliAnalysisTaskSED0_TreeMVA::GetTrueImpactParameter(AliAODMCHeader *mcHeader, TClonesArray* arrayMC, AliAODMCParticle *partD0) const {
  /// true impact parameter calculation

  printf(" AliAnalysisTaskSED0_TreeMVAV1::GetTrueImpactParameter() \n");
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSED0_TreeMVA::CheckOrigin(TClonesArray* arrayMC, AliAODMCParticle *mcPartCandidate) const {		
  //  obsolete method
  /// checking whether the mother of the particles come from a charm or a bottom quark
  //
  printf(" AliAnalysisTaskSED0_TreeMVA V1::CheckOrigin() \n");
...
void AliAnalysisTaskSED0_TreeMVA::CreateMCAcceptanceHistos(){
...
void AliAnalysisTaskSED0_TreeMVA::FillMCAcceptanceHistos(TClonesArray *arrayMC, AliAODMCHeader *mcHeader){
...
Bool_t AliAnalysisTaskSED0_TreeMVA::CheckAcc(TClonesArray* arrayMC,Int_t nProng, Int_t *labDau){
...
void AliAnalysisTaskSED0_TreeMVA::NormIPvar(AliAODEvent *aod, AliAODRecoDecayHF2Prong *part,TClonesArray *arrMC){
  Double_t normIP[2];
  Double_t pointD0[9];
