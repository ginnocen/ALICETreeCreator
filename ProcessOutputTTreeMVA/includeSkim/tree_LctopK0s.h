...
// from TTree tree_LctopK0s/tree_LctopK0s
// found on file: Memory Directory
//////////////////////////////////////////////////////////

#ifndef tree_LctopK0s_h
#define tree_LctopK0s_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *nsigTPC_Pr_0;
   vector<float>   *nsigTOF_Pi_0;
   vector<float>   *nsigTOF_Pr_0;
   ...
   vector<float>   *nsigTPC_Pr_1;
   vector<float>   *nsigTOF_Pi_1;
   vector<float>   *nsigTOF_Pr_1;
   ...
   vector<float>   *nsigTPC_Pi_2;
   vector<float>   *nsigTPC_Pr_2;
   vector<float>   *nsigTOF_Pi_2;
   vector<float>   *nsigTOF_Pr_2;
   ...
   TBranch        *b_nsigTPC_Pr_0;   //!
   TBranch        *b_nsigTOF_Pi_0;   //!
   TBranch        *b_nsigTOF_Pr_0;   //!
   TBranch        *b_dEdxTPC_0;   //!
   TBranch        *b_ToF_0;   //!
   ...
   TBranch        *b_nsigTPC_Pr_1;   //!
   TBranch        *b_nsigTOF_Pi_1;   //!
   TBranch        *b_nsigTOF_Pr_1;   //!
   TBranch        *b_dEdxTPC_1;   //!
   TBranch        *b_ToF_1;   //!
   ...
   TBranch        *b_nsigTPC_Pr_2;   //!
   TBranch        *b_nsigTOF_Pi_2;   //!
   TBranch        *b_nsigTOF_Pr_2;   //!
   TBranch        *b_dEdxTPC_2;   //!
   TBranch        *b_ToF_2;   //!
   ...
   bool   EnabledSkim_signd0;
   bool   EnabledSkim_inv_mass_K0s;
   bool   EnabledSkim_dca_K0s;
   bool   EnabledSkim_imp_par_K0s;
   bool   EnabledSkim_d_len_K0s;
   bool   EnabledSkim_armenteros_K0s;
   bool   EnabledSkim_ctau_K0s;
   bool   EnabledSkim_cos_p_K0s;
   bool   EnabledSkim_pt_K0s;
   bool   EnabledSkim_eta_K0s;
   bool   EnabledSkim_phi_K0s;
   ...
   bool   EnabledSkim_nsigTPC_Pr_0;
   bool   EnabledSkim_nsigTOF_Pi_0;
   bool   EnabledSkim_nsigTOF_Pr_0;
   ...
   bool   EnabledSkim_nsigTPC_Pr_1;
   bool   EnabledSkim_nsigTOF_Pi_1;
   bool   EnabledSkim_nsigTOF_Pr_1;
   ...
   bool   EnabledSkim_nsigTPC_Pr_2;
   bool   EnabledSkim_nsigTOF_Pi_2;
   bool   EnabledSkim_nsigTOF_Pr_2;
   ...
   tree_LctopK0s(TTree *tree=0);
   virtual ~tree_LctopK0s();
...
#ifdef tree_LctopK0s_cxx
tree_LctopK0s::tree_LctopK0s(TTree *tree) : fChain(0)
{
...
//   if (tree == 0) {
      ...
      // }
      //f->GetObject("tree_LctopK0s",tree);

      //}
   Init(tree);
}

tree_LctopK0s::~tree_LctopK0s()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tree_LctopK0s::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t tree_LctopK0s::GetEntriesFast()
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntriesFast();
}
Long64_t tree_LctopK0s::LoadTree(Long64_t entry)
{
...
void tree_LctopK0s::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("nsigTPC_Pr_0", &nsigTPC_Pr_0, &b_nsigTPC_Pr_0);
   fChain->SetBranchAddress("nsigTOF_Pi_0", &nsigTOF_Pi_0, &b_nsigTOF_Pi_0);
   fChain->SetBranchAddress("nsigTOF_Pr_0", &nsigTOF_Pr_0, &b_nsigTOF_Pr_0);
   ...
   fChain->SetBranchAddress("nsigTPC_Pr_1", &nsigTPC_Pr_1, &b_nsigTPC_Pr_1);
   fChain->SetBranchAddress("nsigTOF_Pi_1", &nsigTOF_Pi_1, &b_nsigTOF_Pi_1);
   fChain->SetBranchAddress("nsigTOF_Pr_1", &nsigTOF_Pr_1, &b_nsigTOF_Pr_1);
   ...
   fChain->SetBranchAddress("nsigTPC_Pr_2", &nsigTPC_Pr_2, &b_nsigTPC_Pr_2);
   fChain->SetBranchAddress("nsigTOF_Pi_2", &nsigTOF_Pi_2, &b_nsigTOF_Pi_2);
   fChain->SetBranchAddress("nsigTOF_Pr_2", &nsigTOF_Pr_2, &b_nsigTOF_Pr_2);
   ...
   EnabledSkim_signd0 = kTRUE;
   EnabledSkim_inv_mass_K0s = kTRUE;
   EnabledSkim_dca_K0s = kTRUE;
   EnabledSkim_imp_par_K0s = kTRUE;
   EnabledSkim_d_len_K0s = kTRUE;
   EnabledSkim_armenteros_K0s = kTRUE;
   EnabledSkim_ctau_K0s = kTRUE;
   EnabledSkim_cos_p_K0s = kTRUE;
   EnabledSkim_pt_K0s = kTRUE;
   EnabledSkim_eta_K0s = kTRUE;
   EnabledSkim_phi_K0s = kTRUE;
   ...
   EnabledSkim_nsigTPC_Pr_0 = kTRUE;
   EnabledSkim_nsigTOF_Pi_0 = kTRUE;
   EnabledSkim_nsigTOF_Pr_0 = kTRUE;
   ...
   EnabledSkim_nsigTPC_Pr_1 = kTRUE;
   EnabledSkim_nsigTOF_Pi_1 = kTRUE;
   EnabledSkim_nsigTOF_Pr_1 = kTRUE;
   ...
   EnabledSkim_nsigTPC_Pr_2 = kTRUE;
   EnabledSkim_nsigTOF_Pi_2 = kTRUE;
   EnabledSkim_nsigTOF_Pr_2 = kTRUE;
...
void tree_LctopK0s::Show(Long64_t entry)
{
...
Int_t tree_LctopK0s::Cut(Long64_t entry)
{
