...
void skimTreeLcFromEvt(TString input="AnalysisResults.root",TString output="test.root",TString ttreeout="tree_LctopK0s", Bool_t isMC = kFALSE, Bool_t ispp = kFALSE){
