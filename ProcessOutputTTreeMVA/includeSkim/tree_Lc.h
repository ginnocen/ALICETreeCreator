...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *dca;
   vector<float>   *dist_12;
   vector<float>   *dist_23;
   ...
   bool   EnabledSkim_dist_12;
   bool   EnabledSkim_dist_23;
   bool   EnabledSkim_sig_vert;
...
void tree_Lc::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("dist_12", &dist_12, &b_dist_12);
   fChain->SetBranchAddress("dist_23", &dist_23, &b_dist_23);
   ...
   EnabledSkim_dist_12 = kTRUE;
   EnabledSkim_dist_23 = kTRUE;
   EnabledSkim_sig_vert = kTRUE;
