...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   bool   EnabledSkim_delta_mass_KK;
   bool   EnabledSkim_cos_PiDs;
   bool   EnabledSkim_cos_PiKPhi_3;
...
void tree_Ds::Init(TTree *tree)
{
   ...
   EnabledSkim_delta_mass_KK = kTRUE;
   EnabledSkim_cos_PiDs = kTRUE;
   EnabledSkim_cos_PiKPhi_3 = kTRUE;
