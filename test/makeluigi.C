...
void makeInputAliAnalysisTaskSELctoV0bachelor(){
  ...
  RDHFLctoV0An->SetPidSelectionFlag(9); // 0 -> TOF AND TPC
  ...
  anacutsval[2][3]=0.008; // inv. mass V0 if K0S [GeV/c2]
  anacutsval[2][4]=0.012; // inv. mass V0 if K0S [GeV/c2]
  anacutsval[2][5]=0.012; // inv. mass V0 if K0S [GeV/c2]
  anacutsval[2][6]=0.015; // inv. mass V0 if K0S [GeV/c2]
  anacutsval[2][7]=0.020; // inv. mass V0 if K0S [GeV/c2]
  ...
  anacutsval[4][5]=1.3;    // pT min bachelor track [GeV/c] // AOD by construction
  anacutsval[4][6]=2.0;    // pT min bachelor track [GeV/c] // AOD by construction
  anacutsval[4][7]=2.5;    // pT min bachelor track [GeV/c] // AOD by construction
  ...
  anacutsval[5][3]=0.3;    // pT min V0-positive track [GeV/c]
  anacutsval[5][4]=0.3;    // pT min V0-positive track [GeV/c]
  anacutsval[5][5]=0.4;    // pT min V0-positive track [GeV/c]
  anacutsval[5][6]=0.4;    // pT min V0-positive track [GeV/c]
  anacutsval[5][7]=0.4;    // pT min V0-positive track [GeV/c]
  ...
  anacutsval[6][3]=0.3;    // pT min V0-negative track [GeV/c]
  anacutsval[6][4]=0.3;    // pT min V0-negative track [GeV/c]
  anacutsval[6][5]=0.4;    // pT min V0-negative track [GeV/c]
  anacutsval[6][6]=0.4;    // pT min V0-negative track [GeV/c]
  anacutsval[6][7]=0.4;    // pT min V0-negative track [GeV/c]

  anacutsval[10][0]=0.04;  // d0 max bachelor wrt PV [cm]
  anacutsval[10][1]=0.05;  // d0 max bachelor wrt PV [cm]
  anacutsval[10][2]=0.06;  // d0 max bachelor wrt PV [cm]
  anacutsval[10][3]=0.07;  // d0 max bachelor wrt PV [cm]
  anacutsval[10][4]=0.08;  // d0 max bachelor wrt PV [cm]
  anacutsval[10][5]=0.09;  // d0 max bachelor wrt PV [cm]
  anacutsval[10][6]=0.1;  // d0 max bachelor wrt PV [cm]
  anacutsval[10][7]=0.2;  // d0 max bachelor wrt PV [cm]

  anacutsval[15][0]=0.4; // pT min V0 track [GeV/c]
  anacutsval[15][1]=0.6; // pT min V0 track [GeV/c]
  anacutsval[15][2]=1.1; // pT min V0 track [GeV/c]
  anacutsval[15][3]=1.2; // pT min V0 track [GeV/c]
  anacutsval[15][4]=1.4; // pT min V0 track [GeV/c]
  anacutsval[15][5]=1.6; // pT min V0 track [GeV/c]
  anacutsval[15][6]=1.9; // pT min V0 track [GeV/c]
  anacutsval[15][7]=2.5; // pT min V0 track [GeV/c]

  RDHFLctoV0An->SetCuts(nvars,nptbins,anacutsval);

  RDHFLctoV0An->SetGetNTPCSigmaCutForPreselection(5);
  ...
  if (RDHFLctoV0An->GetPidSelectionFlag()==9) {
    ...
    RDHFLctoV0An->SetBachelorPLimitsForPID(nBachelorPbins,bachelorPlimits);
  }
